...
from core.views.results_view import ResultsView
...
class App(ctk.CTk):
    ...
    def process_data(self, df):
        ...
        DashboardView(self.main_frame, self.current_data, volver_callback=self.show_welcome)  # <-- Ajuste aquí
    ...
    def show_results(self, analysis):
        """Muestra la vista de resultados con opción de volver al inicio"""
        self.clear_main_frame()
        ResultsView(self.main_frame, analysis, volver_callback=self.show_welcome)
